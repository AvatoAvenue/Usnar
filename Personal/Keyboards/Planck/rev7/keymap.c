...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [_GAME] = LAYOUT_planck_grid(
        ...
        KC_LCTL, KC_Z, KC_X, KC_C, KC_SPC, KC_V, MO(_GAMEZ), KC_B, KC_N, KC_M, KC_ESC, TG(_GAME)
    ),
    ...
    [_FUNCZ] = LAYOUT_planck_grid(
        _______, COLEMAKWND, COLEMAK, COLEMAK, QWERTY, _______, _______, KC_MS_BTN4, KC_MS_BTN5, KC_MS_BTN6, KC_MS_BTN7, _______,
        _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______, KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN3, KC_DELETE,
        _______, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______, _______, KC_MS_BTN8, KC_ACL0, KC_ACL1, KC_ACL2, _______,
