...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [_GAME] = LAYOUT_planck_grid(
        ...
        KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_B, KC_Y, KC_U, KC_I, KC_O, KC_P, TG(_GAMEZ),
        KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_T, KC_M, KC_J, KC_K, KC_L, KC_SCLN, KC_LGUI,
        KC_LCTL, KC_Z, KC_X, KC_C, KC_G, KC_SPC, KC_V, MO(_GAMEZ), KC_N, KC_H, KC_COMMA, TG(_GAME)
    ),

    [_GAMEZ] = LAYOUT_planck_grid(
        KC_F12, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
        _______, _______, _______, KC_UP, _______, _______, _______, KC_COMMA, KC_DOT, KC_SLASH, _______, TG(_GAMEZ),
