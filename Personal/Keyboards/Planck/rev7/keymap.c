...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [_GAME] = LAYOUT_planck_grid(
        ...
        KC_TAB, KC_P, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, TG(_GAMEZ),
        KC_LSFT, KC_SCLN, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_LGUI,
        KC_LCTL, KC_GRAVE, KC_Z, KC_X, KC_C, KC_SPC, KC_V, MO(_GAMEZ), KC_B, KC_N, KC_M, TG(_GAME)
    ),
